...
#define FFMPEG_CONFIGURATION "--prefix=/work/build/prefix --target-os=none --arch=wasm32 --enable-cross-compile --cc=emcc --cxx=em++ --ar=emar --ranlib=emranlib --nm=emnm --enable-static --disable-shared --disable-programs --disable-doc --disable-debug --disable-autodetect --disable-network --disable-asm --disable-everything --enable-pthreads --enable-decoder='h264,aac,ass,ssa,pcm_s16le' --enable-demuxer='mov,matroska,ass,wav' --enable-parser='h264,aac' --enable-protocol=file --enable-filter='aresample,aformat,format,scale,anull,null' --enable-zlib --extra-cflags='-O2 -pthread -msimd128 -I/work/build/prefix/include' --extra-ldflags='-pthread -L/work/build/prefix/lib'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/work/build/prefix/share/ffmpeg"
#define AVCONV_DATADIR "/work/build/prefix/share/ffmpeg"
