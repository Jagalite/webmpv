...
self.inspectRetainedColor=async()=>{
 ...
 return {metadata:{colorSpace:heldFrame.colorSpace.toJSON(),format:heldFrame.format,visibleRect:heldFrame.visibleRect.toJSON(),displayWidth:heldFrame.displayWidth,displayHeight:heldFrame.displayHeight,track:videoTrack},reference:await encode(reference)};
};
