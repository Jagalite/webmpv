...
manifest={
 'schema':1,'scope':'M0 software-only local player','buildHost':platform.platform(),
 ...
 'browserBindings':hashed([root/'src/player.ts',root/'web/engine-worker.js',root/'web/audio-worklet.js',root/'web/generated/player.js']),
 ...
 'baselineProfile':{'video':'H.264 SDR yuv420p','audio':'AAC stereo','containers':['MP4','MKV'],'subtitles':'ASS','network':False,'initialHeapBytes':134217728,'maximumHeapBytes':536870912,'pthreadPoolSize':8},
